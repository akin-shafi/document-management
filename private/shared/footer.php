    ...
    <footer class="footer footer-static footer-light">
      <p class="clearfix mb-0 d-none">
        ...
        <span class="float-md-start d-block d-md-inline-block mt-25">COPYRIGHT  &copy; <?php echo date('Y') ?><a class="ms-25" href="https://1.envato.market/pixinvent_portfolio" target="_blank">ToNote Technologies Limited</a>
