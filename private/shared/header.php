...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo url_for('assets/css/apexcharts.css') ?>">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo url_for('assets/css/chart-apex.min.css') ?>">
        ...
        <ul class="nav navbar-nav align-items-center ms-auto">
          ...
          <li class="nav-item dropdown dropdown-user">
             <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <div class="user-nav d-sm-flex d-none"><span class="user-name fw-bolder">Shafi Akin</span><span class="user-status">active</span></div>
                <span class="avatar">
